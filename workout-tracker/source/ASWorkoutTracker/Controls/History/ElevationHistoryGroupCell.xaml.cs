...
{
    public partial class ElevationHistoryGroupCell : ContentView
    {
        public ElevationHistoryGroupCell()
        {
            InitializeComponent();
        }

        public static readonly BindableProperty GroupProperty = BindableProperty.Create(nameof(Group), typeof(Grouping<DateTime, ExerciseLog>), typeof(ElevationHistoryGroupCell), null, propertyChanged: OnGroupPropertyChanged);
        ...
        {
            var context = (ElevationHistoryGroupCell)bindable;
