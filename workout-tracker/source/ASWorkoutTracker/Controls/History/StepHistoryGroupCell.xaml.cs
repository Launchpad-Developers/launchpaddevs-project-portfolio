...
{
    public partial class StepHistoryGroupCell : ContentView
    {
        public StepHistoryGroupCell()
        {
            InitializeComponent();
        }

        public static readonly BindableProperty GroupProperty = BindableProperty.Create(nameof(Group), typeof(Grouping<DateTime, ExerciseLog>), typeof(StepHistoryGroupCell), null, propertyChanged: OnGroupPropertyChanged);
        ...
        {
            var context = (StepHistoryGroupCell)bindable;
